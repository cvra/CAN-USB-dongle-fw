...
#define TIMER_REG       STM32_TIM6
#define TIMER_IRQ_NAME  STM32_TIM6_HANDLER
#define RCC_EN()        rccEnableTIM6(FALSE)
#define RCC_RESET()     rccResetTIM6()
#define NVIC_NB         STM32_TIM6_NUMBER
